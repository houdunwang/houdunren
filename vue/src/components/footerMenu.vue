...
<template>
  <main
    class="grid grid-flow-col content-center justify-items-center justify-around bg-gray-100 border-t border-t-gray-300 py-3 z-10 fixed bottom-0 left-0 right-0 shadow-inner xl:hidden">
