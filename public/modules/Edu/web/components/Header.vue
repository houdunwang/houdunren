      ...
      <nav class="navbar navbar-expand-sm navbar-light bg-light pt-3 pb-3 pl-md-0 pr-md-0">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
          <ul class="navbar-nav mr-auto mt-2 mt-lg-0 font-weight-bold">
            ...
            <li class="nav-item pr-2">
              <a href="https://www.houdunwang.com" class="nav-link" target="_blank">训练营</a>
            </li>
            <li class="nav-item pr-2">
          ...
          <div class="form-inline my-2 my-lg-0" v-if="isLogin">
            <div class="nav-item pr-2 dropdown">
              <a
                ...
                aria-expanded="false"
              >
                <a-avatar :src="user.avatar" shape="square" :size="25" class="mr-2" />
                {{ user.name }}
              </a>
              <div class="dropdown-menu" aria-labelledby="dropdownId">
                <a class="dropdown-item mb-2 mt-2" href="/member/base">修改资料</a>
                <a class="dropdown-item mb-2" href="/member/mobile">绑定手机</a>
                <a class="dropdown-item mb-2" href="/member/avatar">头像设置</a>
                <a class="dropdown-item mb-2" href="/member/password">修改密码</a>
                <a class="dropdown-item mb-2" href="/member/email">绑定邮箱</a>
                <div class="dropdown-divider"></div>
                <router-link class="dropdown-item mb-2" :to="{ name: 'member.order.index' }">我的定单</router-link>
                <router-link class="dropdown-item mb-2" :to="{ name: 'member.lesson.index' }">课程收藏</router-link>
                <router-link class="dropdown-item mb-2" :to="{ name: 'member.video.index' }">视频收藏</router-link>
                <div class="dropdown-divider"></div>
                <router-link
