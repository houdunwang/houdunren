<div class="card">
    ...
    <div class="card-body">
        <x-form title="应用ID" name="alipay[app_id]" value="{{ config('site.alipay.app_id') }}"
        ...
        <x-form title="商户私钥" name="alipay[merchant_private_key]" placeholder="使用支付宝提供的签名生成工具创建，注意不要有换行"
            value="{{ config('site.alipay.merchant_private_key') }}"></x-form>

        <x-form title="支付宝公钥" name="alipay[alipay_public_key]" placeholder="使用支付宝提供的签名生成工具创建，注意不要有换行"
