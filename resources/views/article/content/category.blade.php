...
<button class="btn btn-primary btn-sm mt-3" onclick="change()">保存提交</button> @endsection @push('scripts') <script>
  function change(){
  location.href= `/article/content/create/${document.getElementById('category').value}`
}
</script> @endpush @push('styles') <style>
  option:disabled {
