  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item mr-3">
          <a class="nav-link" href="{{ route('system.module.index') }}">
            <i class="fa fa-cubes" aria-hidden="true"></i> 模块管理
          </a>
        </li>
        <li class="nav-item mr-3">
          <a class="nav-link" href="{{ route('system.template.index') }}">
            <i class="fa fa-archive" aria-hidden="true"></i> 模板管理
          </a>
        </li>
        <li class="nav-item mr-3">
          <a class="nav-link" href="{{ route('system.config.edit') }}">
            <i class="fa fa-camera" aria-hidden="true"></i> 系统设置
          </a>
        </li>
        <li class="nav-item mr-3">
          <a class="nav-link" href="{{ route('system.my.edit') }}">
      ...
      <div class="form-inline my-2 my-lg-0 pr-3">
        <div class="dropdown">
          ...
          <div class=" dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
            ...
            <a class="dropdown-item" href="{{ route('system.my.edit') }}">修改密码</a>
