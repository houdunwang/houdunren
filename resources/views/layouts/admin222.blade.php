...
<div class="wrapper">
        ...
        <nav class="navbar navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    <a href="/" class="navbar-brand"><b>HD</b>CMS</a>
                ...
                <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li><a href="{{route('site.index')}}">站点管理 <span class="sr-only">(current)</span></a></li>
                        <li><a href="#">应用列表</a></li>
                        <li><a href="#">系统设置</a></li>
                        {{--<li class="dropdown">--}}
                    ...
                    <!-- User Account Menu -->
                        <li class="dropdown user user-menu">
                            ...
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <img src="{{asset('org/AdminLTE-2.4.5')}}/dist/img/user2-160x160.jpg" class="user-image"
                                     alt="User Image">
    ...
    <div class="content-wrapper">
        <div class="container  {{route_class()}}">
            <section class="content site-box">
            @yield('content')
            </section>
        </div>
        <!-- /.container -->
...
<script>
    require(['jquery', 'bootstrap'], function ($) {
        require([
            ...
            "{{asset('org/AdminLTE-2.4.5')}}/dist/js/demo.js"
        ])
    })
</script>
@stack('js')
