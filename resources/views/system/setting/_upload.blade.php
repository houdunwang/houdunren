<div class="card">
    ...
    <div class="card-body">
                ...
                <div class="form-check form-check-inline">
                    <label class="form-check-label mr-3">
                        <input class="form-check-input" type="radio" value="local"
                               name="type" {{active_class(($config['type']??'local')=='local','checked')}}> 本地上传
                    </label>
                    <label class="form-check-label">
                        <input class="form-check-input" type="radio" value="aliyun"
                               name="type" {{active_class(($config['type']??'')=='aliyun','checked')}}> 阿里云上传
                    </label>
                </div>
            </div>
        </div>
        ...
        <div class="form-group row">
            <label class="col-sm-1 col-form-label">上传类型 <small class="text-secondary">(extension)</small></label>
            <div class="col-sm-6">
                <input type="text" class="form-control" name="extension"
                       value="{{$config['extension']??'jpg,jpeg,gif,png,zip,rar,doc,txt,pem,json'}}">
