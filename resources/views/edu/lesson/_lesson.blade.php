...
<div class="row" id="app" v-cloak="">
    <div class="col-12">
            ...
            <div class="card-body border-bottom-0">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="type2" v-model="field.lesson.type" class="custom-control-input"
                                   checked
                                   value="video">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="order_learn1" v-model="field.lesson.order_learn"
                                   class="custom-control-input"
                                   value="1" checked>
                            <label class="custom-control-label" for="order_learn1">是</label>
                        </div>
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="order_learn2" v-model="field.lesson.order_learn"
                                   class="custom-control-input"
                                   value="0">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <div class="custom-control custom-checkbox custom-control-inline">
                            <input type="checkbox" class="custom-control-input" v-model="field.lesson.is_hot"
                                   id="is_hot"
                                   value="1">
                            ...
                            <div class="col-sm-10">
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="subscribe_free_play1"
                                           v-model="field.lesson.subscribe_free_play"
        ...
        <div class="card mt-3">
            <div class="card-footer">
                <button class="btn btn-primary btn-sm" type="submit">保存发布</button>
                <button class="btn btn-secondary btn-sm" @click="editLessonVideo= !editLessonVideo" type="button">编辑视频
                </button>
            </div>
        </div>
    </div>
