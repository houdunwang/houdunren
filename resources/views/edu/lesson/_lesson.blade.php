  ...
  <div class="col-12">
                  ...
                  <draggable v-model="field.videos" element="ul"  @start="drag=true" @end="drag=false" class="col-12">
                      <li class="card mb-2" v-for="(video,k) in field.videos" :key="k">
                          ...
                          <div class="card-footer text-muted">
                              ...
                              <button class="btn btn-secondary btn-sm" type="button" @click="addNextVideo(k)">插入视频</button>
                              {{--考题--}}
      ...
      <div class="card mt-3">
          <div class="card-footer">
              ...
              <button class="btn btn-secondary btn-sm" @click="editLessonVideo= !editLessonVideo" type="button">编辑视频</button>
          </div>
      </div>
  </div>
</div>
