...
<head>
    ...
    <link rel="stylesheet" href="{{asset('org/front/vendor')}}/fancybox/jquery.fancybox.css">
                ...
                <div id="navBar" class="collapse navbar-collapse py-0">
                    <ul class="navbar-nav u-header__navbar-nav ml-lg-auto">
                        <li class="nav-item mr-2">
                            <a class="nav-link u-header__nav-link" href="{{route('edu.home.dynamic')}}">
                                碎片
                            </a>
                        </li>
                        <li class="nav-item hs-has-sub-menu u-header__nav-item mr-3"
                            data-event="hover"
                                        ...
                                        <div class="d-none d-lg-block u-header__banner-v1"
                                            ...
                                            <div class="w-100 text-center u-header__banner-v1-content u-content-centered-y p-4">
                                                ...
                                                <a class="btn btn-primary u-btn-primary btn-sm transition-3d-hover"
                                                   href="#">进入直播间 <span class="fa fa-angle-right ml-2"></span></a>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-sm-12">
                                                <ul class="list-unstyled mb-4 row">
                                                    @foreach(\App\Models\EduCategory::get() as $category)
                                                        <li class="col-sm-12">
                                                            <a class="nav-link u-list__link py-3 px-0"
                        ...
                        <li class="nav-item d-none d-md-inline-block pl-3 pr-0">
                            <a class="btn btn-sm btn-primary u-btn-primary transition-3d-hover"
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 mb-7 mb-lg-0">
                        <!-- Project -->
                        <a class="d-block bg-white position-relative shadow-sm rounded-bottom text-center transition-3d-hover" href="../blog/single-article-classic.html">
                            <img class="img-fluid rounded-top" src="{{asset('org/front/img/600x400/img3.jpg')}}" alt="Image Description">
                            <div class="p-5">
                                <h4 class="h5 text-dark mb-0">Nashville</h4>
                    ...
                    <div class="col-md-4 mb-7 mb-lg-0">
                        <!-- Project -->
                        <a class="d-block bg-white position-relative shadow-sm rounded-bottom text-center transition-3d-hover" href="../blog/single-article-classic.html">
                            <img class="img-fluid rounded-top" src="{{asset('org/front/img/600x400/img2.jpg')}}" alt="Image Description">
                            <div class="p-5">
                                <h4 class="h5 text-dark mb-0">Vanilla</h4>
        ...
        <div class="container u-space-3">
          ...
          <span class="u-icon u-icon-primary--air u-icon--xl rounded-circle mb-4">
            <span class="far fa-thumbs-up u-icon__inner"></span>
                ...
                <h2 class="font-weight-medium">为后盾人助力</h2>
            </div>
            <!-- End Title -->
...
<footer class="container">
    ...
    <div class="text-center py-7">
        <div>
            <p class="text-dark">我们的使命：传播互联网前沿技术，帮助更多的人实现梦想</p>
...
{{--<script src="{{asset('org/front/vendor')}}/jquery-validation/dist/jquery.validate.min.js"></script>--}}
{{--<script src="{{asset('org/front/vendor')}}/fancybox/jquery.fancybox.min.js"></script>--}}
...
{{--<script src="{{asset('org/front')}}/js/helpers/hs.focus-state.js"></script>--}}
{{--<script src="{{asset('org/front')}}/js/components/hs.validation.js"></script>--}}
{{--<script src="{{asset('org/front')}}/js/components/hs.fancybox.js"></script>--}}
{{--<script src="{{asset('org/front')}}/js/components/hs.slick-carousel.js"></script>--}}
{{--<script src="{{asset('org/front')}}/js/components/hs.go-to.js"></script>--}}

<script>
    require(['bootstrap'], function () {
        require([
            {{--"{{asset('org/front/vendor')}}/jquery-migrate/dist/jquery-migrate.min.js",--}}
            {{--"{{asset('org/front/vendor')}}/popper.js/dist/umd/popper.min.js",--}}

            "{{asset('org/front/vendor')}}/hs-megamenu/src/hs.megamenu.js",
            {{--"{{asset('org/front/vendor')}}/jquery-validation/dist/jquery.validate.min.js",--}}
            {{--"{{asset('org/front/vendor')}}/fancybox/jquery.fancybox.min.js",--}}
            {{--"{{asset('org/front/vendor')}}/slick-carousel/slick/slick.js",--}}

            "{{asset('org/front')}}/js/hs.core.js",
            "{{asset('org/front')}}/js/components/hs.header.js",
            {{--"{{asset('org/front')}}/js/helpers/hs.focus-state.js",--}}
            {{--"{{asset('org/front')}}/js/components/hs.validation.js",--}}
            {{--"{{asset('org/front')}}/js/components/hs.fancybox.js",--}}
            "{{asset('org/front')}}/js/components/hs.slick-carousel.js",
            "{{asset('org/front')}}/js/components/hs.go-to.js"
