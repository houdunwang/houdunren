...
@section('content')
    ...
    <div class="clearfix">
        <a href="{{route('module.index')}}" class="tile img-rounded">
    ...
    <div class="clearfix">
        <a href="{{route('user.edit',auth()->user())}}" class="tile img-rounded">
            <i class="fa fa-briefcase"></i> <span>我的帐户</span>
        </a>
        <a href="{{route('user.index')}}" class="tile img-rounded">
    ...
    <div class="clearfix">
        ...
        <a href="{{route('update-cache')}}" class="tile img-rounded">
