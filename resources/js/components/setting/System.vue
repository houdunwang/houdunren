        ...
        <el-row :gutter="20">
          <el-col :xs="24" :md="12">
            <el-form-item label="后台名称">
              <el-input placeholder="用于在浏览器标签中显示的名称" v-model="data.base.name.value"></el-input>
            </el-form-item>
            <el-form-item label="后台标志">
              <el-upload
                ...
                :headers="headers"
              >
                <img v-if="data.base.logo.value" :src="data.base.logo.value" class="avatar" />
            ...
            <el-form-item label="明文显示">
              ...
              <div class="el-upload__tip">开启支付宝、阿里云表单的明文显示</div>
            </el-form-item>
          </el-col>
        </el-row>
      </el-tab-pane>
        ...
        <el-row :gutter="20">
          <el-col :xs="24" :md="12">
            <el-form-item label="体验天数">
              <el-input placeholder="可使用后台管理权限的天数" v-model="data.register.days.value">
                <template slot="append">天</template>
              </el-input>
            </el-form-item>

            <el-form-item label="默认会员组">
              <el-select v-model="data.register.group_id.value" placeholder="请选择">
                <el-option
