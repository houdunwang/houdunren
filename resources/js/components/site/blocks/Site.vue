    ...
    <div class="card mb-3 shadow-sm">
        ...
        <div class="card-footer text-muted">
            <div class="d-flex flex-md-row flex-column justify-content-between">
                <div class="small">
                    创建时间: {{ created_at }} 站长 : {{ site.admin.name }}
                </div>
                <div class="lin"></div>
                <div class="small" v-if="isAdmin">
                    ...
                    <a
                        href="https://www.houdunren.com/system/site/18/edit"
...
export default {
    ...
    computed: {
        ...mapState("user", ["user"]),
        created_at() {
            return this.$moment(this.site.created_at, "YYYYMMDD").fromNow();
        },
        isAdmin() {
            return this.user === 1 || this.site.role.role === "admin";
        }
    }
};
</script>
