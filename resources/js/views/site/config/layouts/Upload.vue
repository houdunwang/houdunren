<template>
  <div>
    <div class="alert alert-warning">使用OSS上传需要先设置阿里云</div>
    <div class="card">
      <div class="card-body">
        <el-form :model="form" ref="form" label-width="120px">
          <el-form-item :label="form.upload.drive.title">
            <el-radio-group v-model="form.upload.drive.value" class="align-baseline">
          ...
          <el-form-item :label="form.upload.file_size.title">
            <el-input
              v-model="form.upload.file_size.value"
              :placeholder="form.upload.file_size.desc"
            ></el-input>
          </el-form-item>
