...
class CreateArticleCategoriesTable extends Migration
{
    public function up()
    {
        Schema::create('article_categories', function (Blueprint $table) {
            ...
            $table->string('index_template')->default('index.blade.php');
            $table->string('list_template')->default('list.blade.php');
            $table->string('content_template')->default('content.blade.php');
            $table->timestamps();
        });
    }
