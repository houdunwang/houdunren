        ...
        <el-form :model="form" ref="form" label-width="100px" label-position="right" :inline="false" size="normal">
            ...
            <el-card shadow="always" :body-style="{ padding: '20px' }" class="mt-3">
                ...
                <el-form-item label="免费观看数量" size="normal">
                    ...
                    <hd-error :message="form.errors.free_num" />
                </el-form-item>
            ...
            <el-card shadow="always" :body-style="{ padding: '20px' }" class="mt-3">
                ...
                <el-checkbox-group v-model="form.tags" size="normal" :max="5">
...
export default {
    ...
    data() {
        return {
            tabs,
            form: this.$inertia.form(this.lesson || form)
        }
    },
    methods: {
        onSubmit() {
            if (this.lesson) {
                this.form.put(route('Edu.admin.lesson.update', this.lesson))
            } else {
                this.form.post(route('Edu.admin.lesson.store'))
            }
        }
    }
}
