        ...
        <div class="card-body">
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item pl-0 d-flex justify-content-between">
              ...
              <span data-v-c6b61c04="" class="small text-secondary">{{ $video->created_at->diffForHumans() }}</span>
            </li>
            @endforeach
          </ul>
          <div class="mt-2">
      ...
      <div class="card rounded shadow-sm mb-2">
        ...
        <div class="card-footer text-muted bg-white text-center">
          <div class="d-flex justify-content-between">
            <a href="/topic/create" class="btn btn-outline-success btn-sm flex-fill">
              <i class="fa fa-pencil-square-o"></i> 发贴交流
            </a>
            <a href="/sign" class="btn btn-outline-danger btn-sm flex-fill ml-2">
              <i aria-hidden="true" class="fa fa-flag"></i> 签到打卡
            </a>
          </div>
        </div>
      </div>
