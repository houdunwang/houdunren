        ...
        <div class="card shadow-lg item">
          ...
          <div class="card-footer text-muted text-center pb-5 pt-4 shadow">
            ...
            <div class="btn-group" role="group" aria-label="Basic example">
                  ...
                  <div class="modal-content">
                    <div class="modal-body">
                      ...
                      <div class="btn-group mt-2" role="group">
                        ...
                        <a href="{{ route('Edu.member.duration') }}" class="btn btn-info btn-sm">完成付款</a>
              ...
              @mobile
              <a href="{{ route('Edu.pay.subscribe.wepay',$subscribe['id']) }}" class="btn btn-info btn-sm border-left">
                微信支付
              </a>
              @endmobile
            </div>
