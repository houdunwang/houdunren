...
return [
    ...
    'system' => [
        'base' => [
            'logo' => ['value' => '', 'title' => '后台标志', 'desc' => '后台系统管理界面的标志，尺寸600X100像素'],
            'footer' => ['value' => '', 'title' => '后台页脚', 'desc' => '后台页面底部信息支持HTML'],
            'plaintext' => ['value' => true, 'title' => '明文显示', 'desc' => '开启支付宝、阿里云表单的明文显示']
        ],
        'register' => [
            'days' => ['value' => '365', 'title' => '体验天数', 'desc' => '可使用后台管理权限的天数'],
            'group_id' => ['value' => 'group_id', 'title' => '默认会员组', 'desc' => ''],
        ]
    ],
    //站点配置
    'site' => [
