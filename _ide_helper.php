 ...
 * Generated for Laravel 5.7.16 on 2018-12-09 22:30:26.
 *
...
namespace Houdunwang\Uploader { 
    ...
    class Facade {
        ...
        {
            return \Houdunwang\Uploader\Uploader::config($config);
        }
         ...
         * @static 
         */ 
        public static function upload($file, $service = 'oss')
        {
            return \Houdunwang\Uploader\Uploader::upload($file, $service);
        }
